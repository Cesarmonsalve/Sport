...
export const MlbFieldPositions = memo(function MlbFieldPositions({ widgetFilter }: Props) {
  ...
  return (
    <MovableLayer id="field-positions-widget" className="ss-field-root">
      {SLOTS.map((s, i) => {
        const p = roster[i];
        return (
          <MovableLayer key={s.id} id={s.id} groupParent="field-positions-widget" className="ss-field-slot">
